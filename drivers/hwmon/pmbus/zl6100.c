...
enum chips { zl2004, zl2005, zl2006, zl2008, zl2105, zl2106, zl6100, zl6105,
	     zl9101, zl9117, zls1003, zls4009, zl8802 };
...
#define ZL6100_WAIT_TIME		2000	/* uS	*/
			...
			const struct i2c_device_id *id)
{
	...
	/*
	 * ZL2004, ZL9101M, ZL9117M, ZLS4009 and ZL8802 support monitoring an extra voltage
	 * (VMON for ZL2004, ZLS4009 and ZL8802, VDRV for ZL9101M and ZL9117M).
	 * Report it as vmon.
	 */
	if (data->id == zl2004 || data->id == zl9101 || data->id == zl9117
	      || data->id == zls4009 || data->id == zl8802)
